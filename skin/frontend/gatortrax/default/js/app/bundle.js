...
var conf1 = require('../bower_components/angular/angular.js');
var conf2 = require('../bower_components/angular-route/angular-route.min.js');
var conf3 = require('../bower_components/angular-animate/angular-animate.min.js');
var conf4 = require('../bower_components/angular-ui-router/release/angular-ui-router.min.js');
var conf5 = require('../bower_components/html5-boilerplate/js/vendor/modernizr-2.6.2.min.js');
var conf  = require('./js/config.js');
var conf7 = require('./app.js');
var conf8 = require('./js/controllers.js');
var conf9 = require('./modules/scoreboard/scoreboard.js');
var conf10 = require('./modules/boatModel/boatModel.js');
var conf11 = require('./modules/hullSize/hullSize.js');
var conf12 = require('./modules/motor/motor.js');
var conf13 = require('./modules/saveForLater/saveForLater.js');
var conf14 = require('./modules/deck/deck.js');
var conf15 = require('./modules/look/look.js');
...
//  <script src="modules/scoreboard/scoreboard.js"></script>
//  <script src="modules/boatModel/boatModel.js"></script>
//  <script src="modules/hullSize/hullSize.js"></script>
//  <script src="modules/motor/motor.js"></script>
//  <script src="modules/saveForLater/saveForLater.js"></script>
},{"../bower_components/angular-animate/angular-animate.min.js":10,"../bower_components/angular-route/angular-route.min.js":11,"../bower_components/angular-ui-router/release/angular-ui-router.min.js":12,"../bower_components/angular/angular.js":13,"../bower_components/html5-boilerplate/js/vendor/modernizr-2.6.2.min.js":14,"./app.js":1,"./js/config.js":2,"./js/controllers.js":3,"./modules/boatModel/boatModel.js":5,"./modules/hullSize/hullSize.js":6,"./modules/motor/motor.js":7,"./modules/saveForLater/saveForLater.js":8,"./modules/scoreboard/scoreboard.js":9}],5:[function(require,module,exports){
'use strict';
      ...
      views: 
        {
            'boatModel@': 
            {
                templateUrl: 'modules/boatModel/boatModel.html'
            }
        }
    });
}])
...
.config(['$stateProvider', function($stateProvider) {
    $stateProvider.state("hullSize", 
    {
        ...
        views: 
        {
            'hullSize@': 
            {
                templateUrl: 'modules/hullSize/hullSize.html'
            }
        }
    });
}])

.controller('HullSizeCtrl', ['$scope', '$http', '$filter', function( $scope, $http, $filter)  
{
    $scope.formData         = [];
    $scope.tabs             = [];
        ...
        $scope.bottoms.values.forEach(function(elt)
        {
            ...
            $scope.targetFields.forEach(function(target)
            {
                item[target.name.toLowerCase()] = $filter('getByAttribute')(elt.attributes, 'name', target.name);
                    ...
                    // dynamically reappropriate/associate nested properties with objects
//            $scope.fieldAssociates.forEach(function(target)
//            {   
//                if(target.name === item[target.name.toLowerCase()].name)
//                {
//                    item[target.name.toLowerCase()][target.associate.toLowerCase()] = item[target.name.toLowerCase()][target.associate];
//                }
//            });
      ...
      views: 
        {
            'motor@': 
            {
                templateUrl: 'modules/motor/motor.html'
            }
        }
    });
}])

.controller('MotorCtrl', ['$scope', '$http', function($scope, $http) 
{
    $scope.motorData;
    $scope.motors = [];
    ...
    .success(function(data, status, headers)
    {
        ...
        console.log(Scoreboard.ProcessRules());
    })
    .error(function(data, status, headers, config) 
    {
    ...
    {
        var target = $scope.motorData.types.selected.id - 1;
        
        $scope.motors = $scope.motorData.types[target];
    };
}])
...
.filter('active', function() 
{
    ...
    {
        return item.active === false ? null : item;
    };
});
...
//angular.module('wizard.saveForLater',[])
    app.controller('ButtonCtrl', ['$scope', function($scope){
        ...
        $scope.saveForLater = function(section)
        {
            console.log($scope.section);
        }
        $scope.submitForQuote = function(section)
        {
            console.log($scope.section);
        }
...
{   
    $rootScope.Scoreboard = 
    {
        ...
        CompileRules: function(section)
        {
            // The players are: section, operator, attribute, value 
            // where value is a correllation to a production option


            // prior to displaying elements of a section we need to first
            // run through every element and establish how to display 
            // the element, if at all.  
            // This event should occur on section load


            // In order to validate (prove) each element's rules we need to 
            // iterate over every element from every section, perhaps 
            // we should pre-index the rules first prior to iterating
            // an indexed set of rules could be held within a singleton or such
            // 
            // The indexing model may look something like this:

            var ruleCollection = [
                {
                    section: 2,  // our section from magento as product entity id
                    elements: 
                    [
                        {
                            value: 1,  // our option value id from magento
                            rules: 
                            [
                                {operator: 'has', collection: [{section:3, value:2},5,6,8]},  // our collection holds the 
                                {operator: 'has_not', collection: [7,9,11]}
                            ]
                        }
                    ]
                },
                {
                    section: 3,
                    elements: [{value: 1, rules: [{operator: 'has', collection: [2,5,6,8]}, {operator: 'has_not', collection: [7,9,11]}]}]
                }
            ]; 

            this[section.name].activeRules = collection;
        },

        ProcessRules: function(section)
        {
            return 'Of course...';
        }
    };
