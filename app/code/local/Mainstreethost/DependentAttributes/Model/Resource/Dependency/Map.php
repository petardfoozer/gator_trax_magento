...
class Mainstreethost_DependentAttributes_Model_Resource_Dependency_Map extends Mage_Core_Model_Resource_Db_Abstract
{
    protected function _construct()
    {
         ...
         */
        $this->_init('da/dependency_map', 'dependency_map_id');
    }
}